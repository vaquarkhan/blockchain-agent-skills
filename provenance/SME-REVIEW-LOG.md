...
| Date | Scope | Reviewer role | Outcome | Notes |
| --- | --- | --- | --- | --- |
| 2026-06-13 | Tier 1 skills + guardrails + chain providers | Blockchain platform SME | Approved | Simulate-first lifecycle, KMS-only signing, mainnet thresholds aligned with `guardrails/transaction-safety.yaml` |
