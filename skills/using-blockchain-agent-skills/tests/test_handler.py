"""Tests for using-blockchain-agent-skills Bedrock handler."""
...
def test_routeSkill_action():
    event = {
        "messageVersion": "1.0",
        "actionGroup": "using-blockchain-agent-skills",
        "function": "routeSkill",
        "parameters": [{"name": "intent", "value": "send token on arbitrum"}],
        "sessionId": "test",
    }
