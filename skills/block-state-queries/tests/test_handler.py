"""Tests for block-state-queries Bedrock handler."""
...
def test_queryPlan_action():
    event = {
        "messageVersion": "1.0",
        "actionGroup": "block-state-queries",
        "function": "queryPlan",
        "parameters": [{"name": "chain_name", "value": "ethereum"}, {"name": "query_type", "value": "balance"}],
        "sessionId": "test",
    }
