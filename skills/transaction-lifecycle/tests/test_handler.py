"""Tests for transaction-lifecycle Bedrock handler."""
...
def test_planTransaction_action():
    event = {
        "messageVersion": "1.0",
        "actionGroup": "transaction-lifecycle",
        "function": "planTransaction",
        "parameters": [{"name": "chain_name", "value": "ethereum"}, {"name": "operation", "value": "transfer"}],
        "sessionId": "test",
    }
