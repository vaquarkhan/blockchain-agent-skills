"""Tests for consensus-validator-ops Bedrock handler."""
...
def test_validatorRotationPlan_action():
    event = {
        "messageVersion": "1.0",
        "actionGroup": "consensus-validator-ops",
        "function": "validatorRotationPlan",
